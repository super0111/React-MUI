...
const LinkdIneModal = ({ linkedInModal, setLinkedInModal, workFlowWebsites, setWorkFlowWebsites }) => {
      ...
      <Fade in={linkedInModal}>
        <Box sx={Modalstyle}>
          <Typography sx={{
            ...
            New Workflow Set Up (Company LinkdeIn URLs)
          </Typography>
          <Typography sx={{
            fontFamily: 'Inter',
            fontStyle: "normal",
